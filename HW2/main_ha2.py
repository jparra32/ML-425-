...
def MinMaxScaler(df):
    ...
    scaled_df = (df - minimum) / (maximum - minimum)
...
sat = download_data('sat.csv', [1, 2, 4]) # three columns: MATH SAT, VERB SAT, UNI. GPA  # convert frame to matrix

################PLACEHOLDER2 #start##########################
# Normalize data
sat = MinMaxScaler(sat).values # please replace this code with your own codes
################PLACEHOLDER2 #end##########################
